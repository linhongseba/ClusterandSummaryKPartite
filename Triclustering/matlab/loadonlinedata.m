function [Xpt, Xut, Xrt, Gut, tlabel, ulabel,n,m] = loadonlinedata(k, l)
...
%tlabel: tweet-label
%ulabel: user-label
    tweetfilename = sprintf('./Data/online/37/tweet-word-%d.txt', k);
    ...
    usefilename = sprintf('./Data/online/37/user-word-%d.txt', k);
    Xut=load(usefilename);
    RTfilename = sprintf('./Data/online/37/user-retweet-%d.txt', k);
    Xrt=load(RTfilename);
    %Xrt=spconvert(Xrt);
    m1=size(Xrt,1);
    if m1>0
    ...
    graphfilename = sprintf('./Data/online/37/user-user-graph-%d.txt', k);
    ...
    tlabelfilename = sprintf('./Data/online/37/tweetlabel-%d.txt',k);
    ...
    ulabelfilename = sprintf('./Data/online/37/userlabel-%d.txt',k);
